    ...
    <div class="row justify-content-center">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">modifier les informations de {{  $user->name}}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', $user) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="adress" type="adress" class="form-control @error('adress') is-invalid @enderror" name="adress" value="{{ $user->adress }}" required autocomplete="adress">

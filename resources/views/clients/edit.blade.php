    ...
    <div class="row justify-content-center">
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">modifier les informations de {{  $client->name}}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('clients.update', $client) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="phone" class="form-control  @error('phone') is-invalid @enderror" name="phone" value="{{ $client->phone }}" required autocomplete="phone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="adress" type="adress" class="form-control @error('adress') is-invalid @enderror" name="adress" value="{{ $client->adress }}" required autocomplete="adress">
